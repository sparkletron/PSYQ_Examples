 ...
 * 
 * Example of using textures from CD and playing Audio.
 * 
 * ****DOES NOT WORK AT THE MOMENT, HECK THE DPLAY ISN"T INCLUDED AT THIS POINT****
 * 
 * Move with D-PAD, and change color with X.
 * 
*/
